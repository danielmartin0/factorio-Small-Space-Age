...
data:extend({
	...
	{ type = "noise-expression", name = "smallspage_r_with_D", expression = "smallspage_r / smallspage_D" },

	{ type = "noise-expression", name = "smallspage_one_plus_r", expression = "1 + smallspage_r_with_D" },
	{ type = "noise-expression", name = "smallspage_one_minus_r", expression = "1 - smallspage_r_with_D" },
	{
	...
	{ type = "noise-expression", name = "smallspage_scale", expression = "smallspage_scale_before_D * smallspage_D" },
	...
	{ type = "noise-expression", name = "smallspage_scale_over_r", expression = "smallspage_scale * smallspage_inv_r" },
